    ...
    <div className="app-background">
      ...
      <div className="sections-bar">
        <span
          ...
          style={{ color: '#1e40af' }} // changed from green to dark blue
        ...
        <span className="section-link" style={{ color: '#1e40af' }}>EMAIL MARKETING</span>
        <span className="section-link" style={{ color: '#1e40af' }}>GOOGLE WORKSPACE</span>
        <span className="section-link" style={{ color: '#1e40af' }}>LICENSE</span>
        <span className="section-link" style={{ color: '#1e40af' }}>SUPPORT</span>
        <span className="section-link" style={{ color: '#1e40af' }}>ABOUT</span>
      </div>
